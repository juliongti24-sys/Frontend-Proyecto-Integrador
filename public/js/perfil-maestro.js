const campos = ['perfNombre', 'perfCorreo', 'perfExpediente', 'perfTelefono', 'perfPassword'];
...
function fillForm(data) {
    ...
    document.getElementById('perfExpediente').value = data.expediente || '';
    ...
    if (data.foto_perfil) {
        ...
        avatarText.textContent = data.nombre ? data.nombre.charAt(0).toUpperCase() : 'M';
...
btnEditar.addEventListener('click', () => {
    ...
    document.getElementById('perfExpediente').disabled = true; // Expediente no se edita generalmente
